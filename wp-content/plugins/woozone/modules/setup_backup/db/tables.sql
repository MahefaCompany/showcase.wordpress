...
--
-- Table structure for table `wp_amz_assets`
--

CREATE TABLE IF NOT EXISTS `wp_amz_assets` (
...
--
-- Table structure for table `wp_amz_products`
--

CREATE TABLE IF NOT EXISTS `wp_amz_products` (
...
--
-- Table structure for table `wp_amz_cross_sell`
--

CREATE TABLE IF NOT EXISTS `wp_amz_cross_sell` (
...
--
-- Table structure for table `wp_amz_report_log`
--
...
--
-- Table structure for table `wp_amz_queue`
--

CREATE TABLE IF NOT EXISTS `wp_amz_queue` (
	`id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `wp_amz_search`
--

CREATE TABLE IF NOT EXISTS `wp_amz_search` (
	`id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `wp_amz_locale_reference`
--
-- `country` ENUM('BR','CA','CN','DE','ES','FR','IN','IT','JP','MX','UK','US') NOT NULL DEFAULT 'US',

CREATE TABLE IF NOT EXISTS `wp_amz_locale_reference` (
...
--
-- Table structure for table `wp_amz_amzkeys`
--

CREATE TABLE IF NOT EXISTS `wp_amz_amzkeys` (
...
--
-- Table structure for table `wp_amz_amazon_cache`
--
...
--
-- Table structure for table `wp_amz_import_stats`
...
--
-- Table structure for table `wp_amz_sync_widget`
--

CREATE TABLE `wp_amz_sync_widget` (
	`ID` BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `wp_amz_sync_widget_asins`
--

CREATE TABLE `wp_amz_sync_widget_asins` (
