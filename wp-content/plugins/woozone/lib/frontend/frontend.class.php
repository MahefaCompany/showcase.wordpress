		...
		public function redirect_amazon( $redirect_asin='' ) {
			...
			<?php 
				...
				');
					...
					//var_dump('<pre>', $link , '</pre>'); echo __FILE__ . ":" . __LINE__;die . PHP_EOL;
	...
	<div class="WooZone-cross-sell-loader">
		...
		public function ajax_requests()
		{
			...
			if ( 'update_countries' == $action ) {
				...
				$updateStats = CountryAvailability::getInstance()->update_product_countries( array(
					'product_id' => $product_id,
					'asin' => $asin
				));
				...
				$box = CountryAvailability::getInstance()->box_country_check_details( $product_id, array(
					'with_wrapper' => false,
				));
